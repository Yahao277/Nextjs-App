...
import DashboardMain from './main.component';
...
const DashboardTemplate = (props: IProps) => {
  return (
    <div className="dashboard-layout relative h-screen overflow-hidden bg-gray-100 dark:bg-gray-800">
      <div className="flex items-start justify-between">
        <DashboardSidebar />
        <div className="dashboard-content flex w-full flex-col md:space-y-4">
          <DashboardHeader />
          <DashboardMain {...props} />
        </div>
      </div>
...
// TODO: comment
// const DashboardTemplate2 = (props: IProps) => {
//   return (
